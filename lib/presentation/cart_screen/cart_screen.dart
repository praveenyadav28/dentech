...
class CartScreen extends GetWidget<CartController> {
  ...
  Widget _buildPaymentDetail() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _buildAdminFee(
          adminFeeText: "lbl_consultation".tr, priceText: "lbl_60_00".tr),
      SizedBox(height: 11.v),
      _buildAdminFee(
          adminFeeText: "lbl_admin_fee".tr, priceText: "lbl_01_00".tr),
      SizedBox(height: 11.v),
      _buildAdminFee(
          adminFeeText: "msg_aditional_discount".tr, priceText: "lbl".tr),
      SizedBox(height: 11.v),
      _buildAdminFee(adminFeeText: "lbl_total".tr, priceText: "lbl_61_00".tr)
    ]);
  }
  ...
  Widget _buildPaymentMethod() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _buildAdminFee(adminFeeText: "lbl_visa".tr, priceText: "lbl_change".tr)
    ]);
  }
